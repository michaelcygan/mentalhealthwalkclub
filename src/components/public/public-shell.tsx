    ...
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      >
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between gap-3 px-4 md:px-8">
          ...
          <nav
            aria-label="Main"
            className="hidden items-center gap-5 text-[13px] text-muted-foreground sm:flex"
          >
            <Link to="/walks" className="hover:text-foreground">
              Walks
            </Link>
            <Link to="/walk/new" className="hover:text-foreground">
              Post a walk
            </Link>
      ...
      <footer className="border-t border-border/60 bg-card/40">
        <div className="mx-auto max-w-5xl space-y-3 px-4 py-8 md:px-8">
          <nav
            aria-label="Footer"
            className="flex flex-wrap gap-4 text-[12px] text-muted-foreground"
          >
            <Link to="/walks" className="hover:text-foreground">
              Walks
            </Link>
