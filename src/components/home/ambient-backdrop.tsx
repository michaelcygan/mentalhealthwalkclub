...
/**
 * Ambient backdrop — fixed behind page content, weather-tinted slow drift + dust.
 * CSS-only, GPU-cheap, respects prefers-reduced-motion.
 */
export function AmbientBackdrop() {
  ...
  // Per-tone color stops (3 stops, oklch-ish hex picks tuned for warmth)
  ...
  return (
    ...
    >
      <div className="wp-backdrop-drift absolute inset-0 opacity-60"
        style={{
