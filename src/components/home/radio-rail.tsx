          ...
          >
            <Card className="overflow-hidden rounded-3xl border-border bg-card/90 shadow-soft transition active:scale-[0.98] hover:-translate-y-0.5">
              <div className="relative aspect-square w-full overflow-hidden bg-muted">
                ...
                {s.is_default && (
                  <span className="absolute right-2 top-2 inline-flex items-center gap-1 rounded-full bg-background/90 px-2 py-0.5 text-[10px] font-medium text-forest backdrop-blur">
        ...
        >
          <Card className="overflow-hidden rounded-3xl border-border bg-card/90 shadow-soft transition group-hover:-translate-y-0.5 group-hover:shadow-md">
            <div className="relative aspect-[5/3] w-full overflow-hidden bg-muted">
              ...
              {s.is_default && (
                <span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-background/90 px-2 py-0.5 text-[10px] font-medium text-forest backdrop-blur">
    ...
    <section aria-labelledby="radio-heading">
      ...
      {resumeStation && (
        <div className="mb-2 flex items-center gap-2 px-1">
          <button
            type="button"
            onClick={() => onStart(resumeStation.slug, resumeStation.title)}
            className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1 text-[11px] text-muted-foreground shadow-soft transition hover:text-foreground"
          >
            <RotateCcw className="h-3 w-3" /> Resume {resumeStation.title}
          </button>
        </div>
      )}
