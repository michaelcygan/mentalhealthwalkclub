...
const IMPACT_DESC = "Walk Club Plus unlocks unlimited Radio and keeps the club running. Every dollar above $2.99 is designated to the 988 Suicide & Crisis Lifeline. See the live ledger.";
    ...
    <div className="mx-auto max-w-2xl px-4 pb-24 pt-8">
      <header className="mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Walk Club Plus is $2.99/month. That unlocks unlimited Radio and keeps the club running. Every dollar you add on top is designated to the 988 Suicide &amp; Crisis Lifeline.
        </p>
      </header>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Plus is $2.99/month for unlimited Radio and keeping the club running. Add any amount on top — 100% of that add-on is designated to the 988 Suicide &amp; Crisis Lifeline. Cancel anytime.
            </p>
      ...
      <section className="mt-10 rounded-2xl bg-muted/40 p-5 text-sm text-muted-foreground">
        ...
        <p>
          Each successful Walk Club Plus charge splits into two lines: a $2.99 membership allocation that unlocks unlimited Radio and keeps the app running, and a donation allocation for everything above that. We route 100% of designated allocations to the 988 Suicide &amp; Crisis Lifeline and publish each transfer on the ledger so you can check our math.
        </p>
        <p className="mt-3">
