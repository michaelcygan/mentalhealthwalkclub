...
function TermsPage() {
  return (
    <article className="mx-auto max-w-2xl px-5 py-10 prose prose-neutral">
      ...
      <ul>
        <li>Plus is offered at $2.99/month (or $29/year), with a 30-day free trial for new subscribers. 50% of net Plus revenue is donated to the 988 Suicide &amp; Crisis Lifeline each month.</li>
