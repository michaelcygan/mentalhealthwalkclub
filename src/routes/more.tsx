...
export const Route = createFileRoute("/more")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://mentalhealthwalkclub.com/__l5e/assets-v1/7244738f-35c7-4630-a18d-c08ba328bd68/og-default-v2.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://mentalhealthwalkclub.com/__l5e/assets-v1/7244738f-35c7-4630-a18d-c08ba328bd68/og-default-v2.jpg" },
    ],
  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <Section title="Explore">
        <Row to="/groups" icon={Users} label="Groups" hint="Standing walks" />
